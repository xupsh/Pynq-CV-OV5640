...
architecture behav of gaussian is 
    ...
    "gaussian,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.400000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=15,HLS_SYN_DSP=57,HLS_SYN_FF=4382,HLS_SYN_LUT=6942,HLS_VERSION=2018_2}";
    ...
    signal Block_Mat_exit45_pro_U0_src_rows_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit45_pro_U0_src_rows_V_out_write : STD_LOGIC;
    signal Block_Mat_exit45_pro_U0_src_cols_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit45_pro_U0_src_cols_V_out_write : STD_LOGIC;
    signal Block_Mat_exit45_pro_U0_dst_rows_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit45_pro_U0_dst_rows_V_out_write : STD_LOGIC;
    signal Block_Mat_exit45_pro_U0_dst_cols_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component start_for_Mat2AXIHfu IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_GaussiaIfE IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component gaussian_AXILiteS_s_axi IS
    generic (
...
begin
    gaussian_AXILiteS_s_axi_U : component gaussian_AXILiteS_s_axi
    generic map (
    ...
    port map (
        ...
        rows => rows,
        cols => cols,
        src_rows_V_out_din => Block_Mat_exit45_pro_U0_src_rows_V_out_din,
        src_rows_V_out_full_n => src_rows_V_c_full_n,
        src_rows_V_out_write => Block_Mat_exit45_pro_U0_src_rows_V_out_write,
        src_cols_V_out_din => Block_Mat_exit45_pro_U0_src_cols_V_out_din,
        src_cols_V_out_full_n => src_cols_V_c_full_n,
        src_cols_V_out_write => Block_Mat_exit45_pro_U0_src_cols_V_out_write,
        dst_rows_V_out_din => Block_Mat_exit45_pro_U0_dst_rows_V_out_din,
        dst_rows_V_out_full_n => dst_rows_V_c_full_n,
        dst_rows_V_out_write => Block_Mat_exit45_pro_U0_dst_rows_V_out_write,
        dst_cols_V_out_din => Block_Mat_exit45_pro_U0_dst_cols_V_out_din,
        dst_cols_V_out_full_n => dst_cols_V_c_full_n,
        dst_cols_V_out_write => Block_Mat_exit45_pro_U0_dst_cols_V_out_write);
    ...
    port map (
        ...
        img_rows_V_out_full_n => src_rows_V_c13_full_n,
        img_rows_V_out_write => AXIvideo2Mat_U0_img_rows_V_out_write,
        img_cols_V_out_din => AXIvideo2Mat_U0_img_cols_V_out_din,
        img_cols_V_out_full_n => src_cols_V_c14_full_n,
    ...
    port map (
        ...
        p_src_rows_V_dout => src_rows_V_c13_dout,
        p_src_rows_V_empty_n => src_rows_V_c13_empty_n,
        p_src_rows_V_read => GaussianBlur_U0_p_src_rows_V_read,
        p_src_cols_V_dout => src_cols_V_c14_dout,
        p_src_cols_V_empty_n => src_cols_V_c14_empty_n,
    ...
    port map (
        ...
        if_din => Block_Mat_exit45_pro_U0_src_rows_V_out_din,
        if_full_n => src_rows_V_c_full_n,
        if_write => Block_Mat_exit45_pro_U0_src_rows_V_out_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit45_pro_U0_src_cols_V_out_din,
        if_full_n => src_cols_V_c_full_n,
        if_write => Block_Mat_exit45_pro_U0_src_cols_V_out_write,
        if_dout => src_cols_V_c_dout,
        if_empty_n => src_cols_V_c_empty_n,
        if_read => AXIvideo2Mat_U0_img_cols_V_read);

    dst_rows_V_c_U : component fifo_w32_d4_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit45_pro_U0_dst_rows_V_out_din,
        if_full_n => dst_rows_V_c_full_n,
        if_write => Block_Mat_exit45_pro_U0_dst_rows_V_out_write,
        if_dout => dst_rows_V_c_dout,
        if_empty_n => dst_rows_V_c_empty_n,
        if_read => Mat2AXIvideo_U0_img_rows_V_read);

    dst_cols_V_c_U : component fifo_w32_d4_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit45_pro_U0_dst_cols_V_out_din,
        if_full_n => dst_cols_V_c_full_n,
        if_write => Block_Mat_exit45_pro_U0_dst_cols_V_out_write,
    ...
    src_rows_V_c13_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => src_rows_V_c13_full_n,
        if_write => AXIvideo2Mat_U0_img_rows_V_out_write,
        if_dout => src_rows_V_c13_dout,
        if_empty_n => src_rows_V_c13_empty_n,
        if_read => GaussianBlur_U0_p_src_rows_V_read);

    src_cols_V_c14_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => src_cols_V_c14_full_n,
        if_write => AXIvideo2Mat_U0_img_cols_V_out_write,
        if_dout => src_cols_V_c14_dout,
        if_empty_n => src_cols_V_c14_empty_n,
    ...
    start_for_Mat2AXIHfu_U : component start_for_Mat2AXIHfu
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_GaussiaIfE_U : component start_for_GaussiaIfE
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ap_done <= Mat2AXIvideo_U0_ap_done;
    ap_idle <= (Mat2AXIvideo_U0_ap_idle and GaussianBlur_U0_ap_idle and Block_Mat_exit45_pro_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);
