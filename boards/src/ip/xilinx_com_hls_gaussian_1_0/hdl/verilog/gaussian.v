...
(* CORE_GENERATION_INFO="gaussian,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.400000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=15,HLS_SYN_DSP=57,HLS_SYN_FF=4382,HLS_SYN_LUT=6942,HLS_VERSION=2018_2}" *)
...
wire   [31:0] Block_Mat_exit45_pro_U0_src_rows_V_out_din;
wire    Block_Mat_exit45_pro_U0_src_rows_V_out_write;
wire   [31:0] Block_Mat_exit45_pro_U0_src_cols_V_out_din;
wire    Block_Mat_exit45_pro_U0_src_cols_V_out_write;
wire   [31:0] Block_Mat_exit45_pro_U0_dst_rows_V_out_din;
wire    Block_Mat_exit45_pro_U0_dst_rows_V_out_write;
wire   [31:0] Block_Mat_exit45_pro_U0_dst_cols_V_out_din;
...
fifo_w32_d2_A src_rows_V_c13_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w32_d2_A src_cols_V_c14_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_Mat2AXIHfu start_for_Mat2AXIHfu_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_GaussiaIfE start_for_GaussiaIfE_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = (Mat2AXIvideo_U0_ap_idle & GaussianBlur_U0_ap_idle & Block_Mat_exit45_pro_U0_ap_idle & AXIvideo2Mat_U0_ap_idle);
