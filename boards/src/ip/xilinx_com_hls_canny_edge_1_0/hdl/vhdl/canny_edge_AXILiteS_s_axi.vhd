...
entity canny_edge_AXILiteS_s_axi is
generic (
...
end entity canny_edge_AXILiteS_s_axi;
...
architecture behave of canny_edge_AXILiteS_s_axi is
    ...
    constant ADDR_LOW_THRESHOLD_DATA_0  : INTEGER := 16#20#;
    constant ADDR_LOW_THRESHOLD_CTRL    : INTEGER := 16#24#;
    constant ADDR_HIGH_THRESHOLD_DATA_0 : INTEGER := 16#28#;
    constant ADDR_HIGH_THRESHOLD_CTRL   : INTEGER := 16#2c#;
