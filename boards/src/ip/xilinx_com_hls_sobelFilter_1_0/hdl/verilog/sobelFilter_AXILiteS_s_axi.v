...
`timescale 1ns/1ps
module sobelFilter_AXILiteS_s_axi
#(parameter
...
localparam
    ...
    ADDR_ORDER_DATA_0 = 6'h20,
    ADDR_ORDER_CTRL   = 6'h24,
    WRIDLE            = 2'd0,
    WRDATA            = 2'd1,
    WRRESP            = 2'd2,
    WRRESET           = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_ORDER_DATA_0: begin
                    rdata <= int_order[31:0];
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_ORDER_DATA_0)
            int_order[31:0] <= (WDATA[31:0] & wmask) | (int_order[31:0] & ~wmask);
    end
end
