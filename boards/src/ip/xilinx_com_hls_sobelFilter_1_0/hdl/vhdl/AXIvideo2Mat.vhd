...
architecture behav of AXIvideo2Mat is 
    ...
    signal t_V_3_reg_280 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal exitcond8_i_fu_404_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((exitcond8_i_fu_404_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((exitcond_i_fu_415_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
                    ap_enable_reg_pp1_iter0 <= ap_const_logic_0;
                elsif (((exitcond8_i_fu_404_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    t_V_3_reg_280_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_fu_415_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
                t_V_3_reg_280 <= j_V_fu_420_p2;
            elsif (((exitcond8_i_fu_404_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                t_V_3_reg_280 <= ap_const_lv32_0;
            end if; 
        end if;
    end process;
    ...
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((exitcond8_i_fu_404_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    ap_done_assign_proc : process(ap_done_reg, exitcond8_i_fu_404_p2, ap_CS_fsm_state4)
    begin
        if (((exitcond8_i_fu_404_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    exitcond8_i_fu_404_p2 <= "1" when (t_V_reg_269 = rows_V_reg_467) else "0";
    exitcond_i_fu_415_p2 <= "1" when (t_V_3_reg_280 = cols_V_reg_472) else "0";
    ...
    in_r_TDATA_blk_n_assign_proc : process(AXI_video_strm_V_data_V_0_state, ap_CS_fsm_state2, ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter1, ap_block_pp1_stage0, exitcond_i_reg_506, brmerge_i_reg_515, ap_CS_fsm_pp2_stage0, ap_enable_reg_pp2_iter1, ap_block_pp2_stage0, eol_2_i_reg_350)
    begin
    ...
    internal_ap_ready_assign_proc : process(exitcond8_i_fu_404_p2, ap_CS_fsm_state4)
    begin
        if (((exitcond8_i_fu_404_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    j_V_fu_420_p2 <= std_logic_vector(unsigned(t_V_3_reg_280) + unsigned(ap_const_lv32_1));
