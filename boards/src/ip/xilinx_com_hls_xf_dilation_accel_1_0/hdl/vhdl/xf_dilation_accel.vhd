...
architecture behav of xf_dilation_accel is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "xf_dilation_accel,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.397000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=5,HLS_SYN_DSP=0,HLS_SYN_FF=2402,HLS_SYN_LUT=3860,HLS_VERSION=2018_3}";
    ...
    signal dilation_accel_U0_ap_done : STD_LOGIC;
    signal dilation_accel_U0_ap_continue : STD_LOGIC;
    signal dilation_accel_U0_ap_idle : STD_LOGIC;
    signal dilation_accel_U0_ap_ready : STD_LOGIC;
    signal dilation_accel_U0_p_src_rows_read : STD_LOGIC;
    signal dilation_accel_U0_p_src_cols_read : STD_LOGIC;
    signal dilation_accel_U0_p_src_data_V_read : STD_LOGIC;
    signal dilation_accel_U0_p_dst_data_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal dilation_accel_U0_p_dst_data_V_write : STD_LOGIC;
    ...
    signal start_for_dilation_accel_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_dilation_accel_U0_full_n : STD_LOGIC;
    signal start_for_dilation_accel_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_dilation_accel_U0_empty_n : STD_LOGIC;
    signal dilation_accel_U0_start_full_n : STD_LOGIC;
    signal dilation_accel_U0_start_write : STD_LOGIC;
    ...
    component start_for_dilatiodEe IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component xf_dilation_accel_AXILiteS_s_axi IS
    generic (
...
begin
    xf_dilation_accel_AXILiteS_s_axi_U : component xf_dilation_accel_AXILiteS_s_axi
    generic map (
    ...
    dilation_accel_U0 : component dilation_accel
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    start_for_dilatiodEe_U : component start_for_dilatiodEe
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ap_done <= xfMat2AXIvideo_U0_ap_done;
    ap_idle <= (xfMat2AXIvideo_U0_ap_idle and dilation_accel_U0_ap_idle and Block_Mat_exit43_pro_U0_ap_idle and AXIvideo2xfMat_U0_ap_idle);
    ...
    dilation_accel_U0_ap_continue <= ap_const_logic_1;
    dilation_accel_U0_ap_start <= start_for_dilation_accel_U0_empty_n;
    dilation_accel_U0_start_full_n <= ap_const_logic_1;
    dilation_accel_U0_start_write <= ap_const_logic_0;
    p_dst_TDATA <= xfMat2AXIvideo_U0_p_dst_TDATA;
    p_dst_TDEST <= xfMat2AXIvideo_U0_p_dst_TDEST;
    p_dst_TID <= xfMat2AXIvideo_U0_p_dst_TID;
    p_dst_TKEEP <= xfMat2AXIvideo_U0_p_dst_TKEEP;
    ...
    p_dst_TVALID <= xfMat2AXIvideo_U0_p_dst_TVALID;
    p_src_TREADY <= AXIvideo2xfMat_U0_p_src_TREADY;
    start_for_dilation_accel_U0_din <= (0=>ap_const_logic_1, others=>'-');
