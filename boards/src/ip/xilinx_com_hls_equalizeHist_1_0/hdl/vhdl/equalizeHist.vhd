...
architecture behav of equalizeHist is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "equalizeHist,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=14.028500,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=3,HLS_SYN_DSP=9,HLS_SYN_FF=4394,HLS_SYN_LUT=7794,HLS_VERSION=2018_3}";
    ...
    signal Block_Mat_exit49_pro_U0_gray_hist_rows_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit49_pro_U0_gray_hist_rows_V_out_write : STD_LOGIC;
    signal Block_Mat_exit49_pro_U0_gray_hist_cols_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit49_pro_U0_gray_hist_cols_V_out_write : STD_LOGIC;
    ...
    signal gray_hist_rows_V_c_full_n : STD_LOGIC;
    signal gray_hist_rows_V_c_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal gray_hist_rows_V_c_empty_n : STD_LOGIC;
    signal gray_hist_cols_V_c_full_n : STD_LOGIC;
    signal gray_hist_cols_V_c_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal gray_hist_cols_V_c_empty_n : STD_LOGIC;
    ...
    signal src_rows_V_c22_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal src_rows_V_c22_empty_n : STD_LOGIC;
    signal src_cols_V_c23_full_n : STD_LOGIC;
    signal src_cols_V_c23_dout : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal gray_hist_data_strea_full_n : STD_LOGIC;
    signal gray_hist_data_strea_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal gray_hist_data_strea_empty_n : STD_LOGIC;
    ...
    port (
        ...
        gray_hist_rows_V_out_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        gray_hist_rows_V_out_full_n : IN STD_LOGIC;
        gray_hist_rows_V_out_write : OUT STD_LOGIC;
        gray_hist_cols_V_out_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        gray_hist_cols_V_out_full_n : IN STD_LOGIC;
        gray_hist_cols_V_out_write : OUT STD_LOGIC );
    end component;
    ...
    component equalizeHist_AXILiteS_s_axi IS
    generic (
...
begin
    equalizeHist_AXILiteS_s_axi_U : component equalizeHist_AXILiteS_s_axi
    generic map (
    ...
    port map (
        ...
        gray_hist_rows_V_out_din => Block_Mat_exit49_pro_U0_gray_hist_rows_V_out_din,
        gray_hist_rows_V_out_full_n => gray_hist_rows_V_c_full_n,
        gray_hist_rows_V_out_write => Block_Mat_exit49_pro_U0_gray_hist_rows_V_out_write,
        gray_hist_cols_V_out_din => Block_Mat_exit49_pro_U0_gray_hist_cols_V_out_din,
        gray_hist_cols_V_out_full_n => gray_hist_cols_V_c_full_n,
        gray_hist_cols_V_out_write => Block_Mat_exit49_pro_U0_gray_hist_cols_V_out_write);
    ...
    port map (
        ...
        p_src_rows_V_dout => gray_img_rows_V_c_dout,
        p_src_rows_V_empty_n => gray_img_rows_V_c_empty_n,
        p_src_rows_V_read => Equalize_U0_p_src_rows_V_read,
        p_src_cols_V_dout => gray_img_cols_V_c_dout,
        p_src_cols_V_empty_n => gray_img_cols_V_c_empty_n,
        ...
        p_dst_data_stream_V_full_n => gray_hist_data_strea_full_n,
    ...
    port map (
        ...
        p_src_rows_V_dout => gray_hist_rows_V_c_dout,
        p_src_rows_V_empty_n => gray_hist_rows_V_c_empty_n,
        p_src_rows_V_read => CvtColor_1_U0_p_src_rows_V_read,
        p_src_cols_V_dout => gray_hist_cols_V_c_dout,
        p_src_cols_V_empty_n => gray_hist_cols_V_c_empty_n,
        p_src_cols_V_read => CvtColor_1_U0_p_src_cols_V_read,
        p_src_data_stream_V_dout => gray_hist_data_strea_dout,
        p_src_data_stream_V_empty_n => gray_hist_data_strea_empty_n,
    ...
    gray_hist_rows_V_c_U : component fifo_w32_d5_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit49_pro_U0_gray_hist_rows_V_out_din,
        if_full_n => gray_hist_rows_V_c_full_n,
        if_write => Block_Mat_exit49_pro_U0_gray_hist_rows_V_out_write,
        if_dout => gray_hist_rows_V_c_dout,
        if_empty_n => gray_hist_rows_V_c_empty_n,
        if_read => CvtColor_1_U0_p_src_rows_V_read);

    gray_hist_cols_V_c_U : component fifo_w32_d5_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit49_pro_U0_gray_hist_cols_V_out_din,
        if_full_n => gray_hist_cols_V_c_full_n,
        if_write => Block_Mat_exit49_pro_U0_gray_hist_cols_V_out_write,
        if_dout => gray_hist_cols_V_c_dout,
        if_empty_n => gray_hist_cols_V_c_empty_n,
    ...
    src_rows_V_c22_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    src_cols_V_c23_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    gray_hist_data_strea_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => gray_hist_data_strea_full_n,
        if_write => Equalize_U0_p_dst_data_stream_V_write,
        if_dout => gray_hist_data_strea_dout,
        if_empty_n => gray_hist_data_strea_empty_n,
    ...
    ap_done <= Mat2AXIvideo_U0_ap_done;
    ap_idle <= (Mat2AXIvideo_U0_ap_idle and Equalize_U0_ap_idle and CvtColor_U0_ap_idle and CvtColor_1_U0_ap_idle and Block_Mat_exit49_pro_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);
