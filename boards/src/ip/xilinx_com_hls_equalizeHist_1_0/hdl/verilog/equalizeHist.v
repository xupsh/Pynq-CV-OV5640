...
(* CORE_GENERATION_INFO="equalizeHist,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=14.028500,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=3,HLS_SYN_DSP=9,HLS_SYN_FF=4394,HLS_SYN_LUT=7794,HLS_VERSION=2018_3}" *)
...
wire   [31:0] Block_Mat_exit49_pro_U0_gray_hist_rows_V_out_din;
wire    Block_Mat_exit49_pro_U0_gray_hist_rows_V_out_write;
wire   [31:0] Block_Mat_exit49_pro_U0_gray_hist_cols_V_out_din;
wire    Block_Mat_exit49_pro_U0_gray_hist_cols_V_out_write;
...
wire    gray_hist_rows_V_c_full_n;
wire   [31:0] gray_hist_rows_V_c_dout;
wire    gray_hist_rows_V_c_empty_n;
wire    gray_hist_cols_V_c_full_n;
wire   [31:0] gray_hist_cols_V_c_dout;
wire    gray_hist_cols_V_c_empty_n;
...
wire   [31:0] src_rows_V_c22_dout;
wire    src_rows_V_c22_empty_n;
wire    src_cols_V_c23_full_n;
wire   [31:0] src_cols_V_c23_dout;
...
wire    gray_hist_data_strea_full_n;
wire   [7:0] gray_hist_data_strea_dout;
wire    gray_hist_data_strea_empty_n;
...
equalizeHist_AXILiteS_s_axi #(
    .C_S_AXI_ADDR_WIDTH( C_S_AXI_AXILITES_ADDR_WIDTH ),
    .C_S_AXI_DATA_WIDTH( C_S_AXI_AXILITES_DATA_WIDTH ))
equalizeHist_AXILiteS_s_axi_U(
...
fifo_w32_d5_A gray_hist_rows_V_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w32_d5_A gray_hist_cols_V_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w32_d2_A src_rows_V_c22_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w32_d2_A src_cols_V_c23_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w8_d2_A gray_hist_data_strea_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = (Mat2AXIvideo_U0_ap_idle & Equalize_U0_ap_idle & CvtColor_U0_ap_idle & CvtColor_1_U0_ap_idle & Block_Mat_exit49_pro_U0_ap_idle & AXIvideo2Mat_U0_ap_idle);
